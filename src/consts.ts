...
export const REVIEWS = [
  { name: 'ミズシナオキ さん', stars: 5, text: 'ストレッチで身体がほぐれて普段運動しないけど、運動したくなりました。' },
  { name: 'I J さん', stars: 5, text: '普段ストレッチ出来ない箇所もしっかり伸ばせて気持ち良かったです。また利用したいです。' },
  { name: '川崎靖幸 さん', stars: 4, text: '身体がものすごく伸びました。施術されている時は、とても疲れましたが血流が良くなり、心地よい疲労感で、とても良かったです。' },
  { name: 'q132473 さん', stars: 5, text: '知人から紹介頂きお邪魔させて頂きました。マッサージ＋ストレッチという今まで経験した事が無い施術で終わった後は血行が良くなってポカポカしました🔥スタッフの方もとても感じ良くリラックスして過ごす事が出来ました。満足度が高かったので私の友人にも紹介させて頂きました。これからも頑張ってください。応援してます📣' },
  { name: 'ma.f さん', stars: 5, text: 'いろいろな角度からアプローチしてもらいました。とにかくよかったです。' },
  { name: '片山翔貴 さん', stars: 5, text: '一回の施術で体が楽になった' },
  { name: 'aya さん', stars: 5, text: '通常のマッサージよりもスッキリ感があり、効果も期待できそうです♪痛気持ちよくて最高でした！' },
  { name: '鈴木秀明 さん', stars: 4, text: 'よくある揉みほぐしではなく、伸ばす感じで自分が求めているタイプのマッサージだった。終わった後は身体が温まって、スッキリしました。' },
  { name: 'Mr.ボブ さん', stars: 5, text: '体が軽い✨ありがとうございます✨' },
  { name: 'Takeshi Hosoe さん', stars: 5, text: '腰回り重点でやってもらいました。状態を確認してもらいながら施術してくださり、親切で良かったです。筋肉の場所の説明もありました。終わって、腰回りの感覚が楽になりました。ありがとうございます。' },
];
