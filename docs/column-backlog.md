...
- [ ] dynamic-static-chigai ｜ authority ｜ 動的ストレッチ 静的ストレッチ 違い 使い分け ｜ 解説 ｜ /symptoms/sports
- [ ] undousoku-5min ｜ authority ｜ 運動不足 解消 1日5分 ストレッチ ｜ 入門 ｜ /symptoms/sports, /symptoms/jiritsu

### 比較・検討系（高意図）
- [ ] personal-stretch-towa ｜ authority ｜ パーソナルストレッチ とは 初めて ｜ 入門 ｜ /menu, /reserve
